...
describe("isFive(num)", () => { /
  it("should return true if the num is 5 otherwise false", () => {
    ...
    //Assert
    expect(actual).to.equal(expectedAnswer); // Although we can write it this. it is more readable with a refactor
...
describe("isOdd(number)", () => {
  it("should return true if number is odd", () => {
    ...
    const expectedAnswer = true; // since num1, num2, and num3 are all odd
    //Assert
